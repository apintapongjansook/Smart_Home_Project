...
void create_screen_setting_page() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_shadow_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    objects.temp_alarm = obj;
                    lv_obj_set_pos(obj, 27, 50);
                    lv_obj_set_size(obj, 51, 22);
                    lv_roller_set_options(obj, "10.0\n10.5\n11.0\n11.5\n12.0\n12.5\n13.0\n13.5\n14.0\n14.5\n15.0\n15.5\n16.0\n16.5\n17.0\n17.5\n18.0\n18.5\n19.0\n19.5\n20.0\n20.5\n21.0\n21.5\n22.0\n22.5\n23.0\n23.5\n24.0\n24.5\n25.0\n25.5\n26.0\n26.5\n27.0\n27.5\n28.0\n28.5\n29.0\n29.5\n30.0\n30.5\n31.0\n31.5\n32.0\n32.5\n33.0\n33.5\n34.0\n34.5\n35.0\n35.5\n36.0\n36.5\n37.0\n37.5\n38.0\n38.5\n39.0\n39.5\n40.0\n40.5\n41.0", LV_ROLLER_MODE_NORMAL);
        ...
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj17 = obj;
            lv_obj_set_pos(obj, 43, 23);
            lv_obj_set_size(obj, 74, 63);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_opa(obj, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
